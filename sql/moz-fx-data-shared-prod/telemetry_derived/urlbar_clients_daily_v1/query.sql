with temp_picked as (
  ...
  SELECT
    ...
    mozfun.map.sum(
      ARRAY_AGG(
        STRUCT(searchmode_type AS key, probe_searchmode.value AS value)
      )
  ...
  CROSS JOIN
    UNNEST([
      STRUCT("bookmarkmenu" AS searchmode_type, scalar_parent_urlbar_searchmode_bookmarkmenu_sum AS probe),
      STRUCT("handoff" AS searchmode_type, scalar_parent_urlbar_searchmode_handoff_sum AS probe),
      STRUCT("keywordoffer" AS searchmode_type, scalar_parent_urlbar_searchmode_keywordoffer_sum AS probe),
      STRUCT("oneoff" AS searchmode_type, scalar_parent_urlbar_searchmode_oneoff_sum AS probe),
      STRUCT("other" AS searchmode_type, scalar_parent_urlbar_searchmode_other_sum AS probe),
      STRUCT("shortcut" AS searchmode_type, scalar_parent_urlbar_searchmode_shortcut_sum AS probe),
      STRUCT("tabmenu" AS searchmode_type, scalar_parent_urlbar_searchmode_tabmenu_sum AS probe),
      STRUCT("tabtosearch" AS searchmode_type, scalar_parent_urlbar_searchmode_tabtosearch_sum AS probe),
      STRUCT("tabtosearch_onboard" AS searchmode_type, scalar_parent_urlbar_searchmode_tabtosearch_onboard_sum AS probe),
      STRUCT("topsites_newtab" AS searchmode_type, scalar_parent_urlbar_searchmode_topsites_newtab_sum AS probe),
      STRUCT("topsites_urlbar" AS searchmode_type, scalar_parent_urlbar_searchmode_topsites_urlbar_sum AS probe),
      STRUCT("touchbar" AS searchmode_type, scalar_parent_urlbar_searchmode_touchbar_sum AS probe),
      STRUCT("typed" AS searchmode_type, scalar_parent_urlbar_searchmode_typed_sum AS probe)
    ])
  CROSS JOIN
